...
public class AgendaDataSource {
	...
	public Event createEvent(String title, String location, String start, String end, 
		...
		id = database.insert(SQLiteHelper.TABLE_EVENTS, null, values);
	...
	public Event getEvent(long id) {
		...
		String Query = "Select * From " + SQLiteHelper.TABLE_EVENTS + " Where " + SQLiteHelper.COLUMN_ID + " = " + id;
	...
	private Event cursorToEvent(Cursor cursor) {
		...
		event.setDetails(cursor.getString(5));
