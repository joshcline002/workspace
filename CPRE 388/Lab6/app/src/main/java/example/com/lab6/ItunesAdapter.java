...
public class ItunesAdapter extends ArrayAdapter<ItunesRecord>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String album = "Album: " + itunesRecord.getAlbumTitle();
		String song = ("Song: " + itunesRecord.getSongTitle());
		holder.itunesAlbumName.setText(album);
		holder.itunesSongTitle.setText(song);

		Log.e("Record: ", album + " " + song);
